  ...
  <div class="row">
    <div class="col-md-offset-2">
      <div class="col-md-4">
        ...
        <p>Barkly East Local Radio Station</p>
        </a>
      </div>
      <div class="col-md-4">
        <a href="http://138.197.190.11/">
        <img class="img" src="{{asset('images/qart.bmp')}}" alt="Question Art Ecommerce-site image link">
        <span>offline</span>
        <h2>Question Art</h2>
          <p>Question Art ecommerce site</p>
        </a>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-12 col-md-offset-1">
    ...
    <div class="col-md-9">
      ...
      <blockquote>
        ...
        <h1>Would you like your own marketing space?</h1>
...
<hr>
    <p>For a website of your own, simply contact us on the contact details listed at the top of this page.</p>
    <span>First five customers get 75% off!</span>
    <br><br>
  <br>
  <br>
  <br>
